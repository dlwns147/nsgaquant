...
sleb_figure = f'fig/layer/total_pruning_time.png'
...
axes[0, 0].plot(our_layer_7b_param, our_layer_7b_c4_ppl, color='blue', label='Our Layer (128)')
axes[0, 0].plot(our_layer_7b_32_param, our_layer_7b_32_c4_ppl, color='olive', label='Our Layer (32)')
axes[0, 0].plot(our_layer_7b_64_param, our_layer_7b_64_c4_ppl, color='brown', label='Our Layer (64)')
...
axes[0, 0].set_yticks(np.array(range(0, 60, 10)))
...
axes[0, 1].plot(our_layer_7b_param, our_layer_7b_w2_ppl, color='blue', label='Our Layer (128)')
axes[0, 1].plot(our_layer_7b_32_param, our_layer_7b_32_w2_ppl, color='olive', label='Our Layer (32)')
axes[0, 1].plot(our_layer_7b_64_param, our_layer_7b_64_w2_ppl, color='brown', label='Our Layer (64)')
...
axes[0, 1].set_yticks(np.array(range(0, 60, 10)))
...
axes[0, 2].plot(our_layer_7b_param, our_layer_7b_zeroshot, color='blue', label='Our Layer (128)')
axes[0, 2].plot(our_layer_7b_32_param, our_layer_7b_32_zeroshot, color='olive', label='Our Layer (32)')
axes[0, 2].plot(our_layer_7b_64_param, our_layer_7b_64_zeroshot, color='brown', label='Our Layer (64)')
...
axes[1, 0].plot(our_layer_13b_param, our_layer_13b_c4_ppl, color='blue', label='Our Layer (128)')
axes[1, 0].plot(our_layer_13b_32_param, our_layer_13b_32_c4_ppl, color='olive', label='Our Layer (32)')
axes[1, 0].plot(our_layer_13b_64_param, our_layer_13b_64_c4_ppl, color='brown', label='Our Layer (64)')
...
axes[1, 1].plot(our_layer_13b_param, our_layer_13b_w2_ppl, color='blue', label='Our Layer (128)')
axes[1, 1].plot(our_layer_13b_32_param, our_layer_13b_32_w2_ppl, color='olive', label='Our Layer (32)')
axes[1, 1].plot(our_layer_13b_64_param, our_layer_13b_64_w2_ppl, color='brown', label='Our Layer (64)')
...
axes[1, 2].plot(our_layer_13b_param, our_layer_13b_zeroshot, color='blue', label='Our Layer (128)')
axes[1, 2].plot(our_layer_13b_32_param, our_layer_13b_32_zeroshot, color='olive', label='Our Layer (32)')
axes[1, 2].plot(our_layer_13b_64_param, our_layer_13b_64_zeroshot, color='brown', label='Our Layer (64)')
