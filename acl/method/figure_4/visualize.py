...
awq_7b = '/NAS/Woo/Automation/autoopt/result/awq_random_sample/Llama-2-7b-hf-awq.csv'
awq_7b_after_300 = '/NAS/Woo/Automation/autoopt/result/awq_random_sample/Llama-2-7b-hf-awq_300.csv'
...
awq_7b_after_300_data = []
with open(awq_7b_after_300, 'r') as f:
    reader = csv.reader(f)
    for row in reader:
        awq_7b_after_300_data.append(row)
awq_7b_after_300_data = awq_7b_after_300_data[1:]
awq_7b_after_300_data = [[float(x[1]), float(x[2])] for x in awq_7b_after_300_data]
...
for i in range(len(awq_7b_after_300_data)):
    if (awq_7b_after_300_data[i][1] < threshold) and (hqq_7b_data[i + 300][1] < threshold):
        awq_7b_bits.append(awq_7b_after_300_data[i][0])
        awq_7b_ppl.append(awq_7b_after_300_data[i][1])
        hqq_7b_bits.append(hqq_7b_data[i + 300][0])
        hqq_7b_ppl.append(hqq_7b_data[i + 300][1])
