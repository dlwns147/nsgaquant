...
amq_13b_bit = [float(i) + 0.25 for i in amq_13b_bit]
...
owq_13b_bit = [float(i) + 0.25 for i in owq_13b_bit]
...
pb_llm_13b_bit = [float(i) + 0.25 for i in pb_llm_13b_bit]
...
bitstack_13b_bit = [float(i) + 0.25 for i in bitstack_13b_bit]
...
amq_13b_memory = [bit * one_bit_memory + scale_zero_memory + embed_head_memory for bit in amq_13b_bit]
...
def func0():
    ax1[0].plot(amq_13b_bit, amq_13b_avg, linestyle = linestyle, label='AMQ', marker='o', markersize=markersize, color='r', linewidth=linewidth, zorder=10)
    ...
    ax1[0].plot(bitstack_13b_bit, bitstack_13b_avg, linestyle = linestyle, label='BitStack', marker='o', markersize=markersize, color='orange', linewidth=linewidth, zorder = 1)
    ax1[0].plot(pb_llm_13b_bit, pb_llm_13b_avg, linestyle = linestyle, label='PB-LLM', marker='o', markersize=markersize, color=colors[4], linewidth=linewidth)

    ax1[0].scatter(awq_13b_bit, awq_13b_avg, label='AWQ', s=s, color='blue', marker='*', zorder=11)
    ax1[0].scatter(gptq_13b_bit, gptq_13b_avg, label='GPTQ', s=s, color='brown', marker='*', zorder=11)

def func1():
    ax1[1].plot(amq_13b_bit, amq_13b_avg, linestyle = linestyle, label='AMQ', marker='o', markersize=markersize, color='r', linewidth=linewidth, zorder=10)
    ...
    ax1[1].plot(pb_llm_13b_bit, pb_llm_13b_avg, linestyle = linestyle, label='PB-LLM', marker='o', markersize=markersize, color=colors[4], linewidth=linewidth)
    ax1[1].plot(bitstack_13b_bit, bitstack_13b_avg, linestyle = linestyle, label='BitStack', marker='o', markersize=markersize, color='orange', linewidth=linewidth, zorder=1)
    
    ax1[1].scatter(awq_13b_bit, awq_13b_avg, label='AWQ', s=s, color='blue', marker='*', zorder=11)
    ax1[1].scatter(gptq_13b_bit, gptq_13b_avg, label='GPTQ', s=s, color='brown', marker='*', zorder=11)
# plt.xlabel('Bit')
