...
axes[0].scatter(train_targets, train_output, s=5, label='trainset')
...
# axes[1].plot(pbllm_7b_bits, pbllm_7b_w2_ppl, label='pb-llm')
axes[1].scatter(test_targets, test_output, s=5, label='testset')
