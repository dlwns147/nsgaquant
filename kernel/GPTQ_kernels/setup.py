...
if BUILD_CUDA_EXT:
    ...
    extensions = [
        cpp_extension.CUDAExtension(
            "custom_gptq",
            [
                "custom_gptq_cuda_kernel_woo.cu"
            ]
        )
    ]
    # extensions = [
    ...
    #         "autogptq_cuda_64",
    #         [
    #             "autogptq_extension/cuda_64_ori/autogptq_cuda_64.cpp",
    #             "autogptq_extension/cuda_64_ori/autogptq_cuda_kernel_64.cu"
    #         ]
    #     ),
    #     cpp_extension.CUDAExtension(
    #         "autogptq_cuda_256",
    #         [
    #             "autogptq_extension/cuda_256_ori/autogptq_cuda_256.cpp",
    #             "autogptq_extension/cuda_256_ori/autogptq_cuda_kernel_256.cu"
    #         ]
    #     )
    # ]
